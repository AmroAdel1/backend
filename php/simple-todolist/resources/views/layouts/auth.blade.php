...
/* FIXED: Icon stays centered regardless of error state */
.input-icon {
    position: absolute;
    left: 1rem;
    top: 1.0625rem; /* Fixed position: (input height 3.125rem / 2) - (icon height 1.125rem / 2) */
    color: #9ca3af;
    font-size: 1.125rem;
    z-index: 2;
    pointer-events: none;
...
.alert {
    ...
    border: none;
    font-size: 0.875rem;
    justify-content: left;  /* Center the logout message  // center */
    text-align: center;
}
...
<body>
    ...
    {{-- <div class="back-to-home">
        <a href="{{ route('todos.index') }}">     <!--  auth.login -->
            <i class="bi bi-arrow-left"></i>
            Back to Home
        </a>
    </div> --}}
